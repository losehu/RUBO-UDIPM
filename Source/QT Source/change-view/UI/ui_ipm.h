...
#endif // QT_CONFIG(shortcut)
        save->setText(QCoreApplication::translate("IpmWindow", "\344\277\235\345\255\230\345\233\276\347\211\207", nullptr));
#if QT_CONFIG(shortcut)
        save->setShortcut(QCoreApplication::translate("IpmWindow", "Ctrl+S", nullptr));
#endif // QT_CONFIG(shortcut)
