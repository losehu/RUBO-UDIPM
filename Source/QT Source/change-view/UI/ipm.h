/********************************************************************************
** Form generated from reading UI file 'IpmWindow.ui'
**
...
public:
    ...
    void setupUi(QMainWindow *IpmWindow)
    {
        if (IpmWindow->objectName().isEmpty())
            IpmWindow->setObjectName(QString::fromUtf8("IpmWindow"));
    ...
    void retranslateUi(QMainWindow *IpmWindow)
    {
        ...
        pushButton->setText(QCoreApplication::translate("IpmWindow", "PushButton", nullptr));
...
namespace Ui {
    class IpmWindow: public Ui_MainWindow {};
} // namespace Ui
